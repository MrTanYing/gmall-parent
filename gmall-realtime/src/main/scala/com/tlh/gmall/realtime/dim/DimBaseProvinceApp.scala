...
import com.tlh.gmall.realtime.bean.ProvinceInfo
...
object DimBaseProvinceApp {
    def main(args: Array[String]): Unit = {
        ...
        provinceDstream.foreachRDD{rdd=>
            rdd.saveToPhoenix("GMALL_PROVINCE_INFO",Seq("ID", "NAME",  "AREA_CODE","ISO_CODE","ISO_3166_2"),new Configuration,Some("hadoop102,hadoop103,hadoop104:2181"))
